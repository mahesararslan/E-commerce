...
export function CustomButton({ children, url }: { children: React.ReactNode, url?: string }) {
    return (
      <a href={url} className="w-60 relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl bg-gradient-to-r from-cyan-500 to-sky-900 group">
